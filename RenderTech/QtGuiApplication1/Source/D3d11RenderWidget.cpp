...
void D3d11RenderWidget::ResizeD3D()
{
...
void D3d11RenderWidget::InitScene()
{
	...
	hr=D3DX11CompileFromFile(L"Shaders\\Effects.fx",0,0,"VS","vs_5_0",0,0,0,&m_VS_buffer,0,0);
	hr=D3DX11CompileFromFile(L"Shaders\\Effects.fx",0,0,"PS","ps_5_0",0,0,0,&m_PS_buffer,0,0);
...
void D3d11RenderWidget::CompileEffect()
{
	DWORD shaderFlags = 0;
	...
	HRESULT hr = D3DX11CompileFromFile(L"Shaders\\Effects.fx", 0, 0, 0, "fx_5_0", shaderFlags, 0, 0, &compiledShader, &compilationMsgs, 0);
